# -*- coding: utf-8 -*-
"""
Created on Tue Nov 24 11:01:02 2020
...
affair= pd.read_csv("C:/RAVI/Data science/Assignments/Module 9 Logistic regression/affairss111.csv")
...
roc_auc = metrics.auc(fpr,tpr) ## 72.82%
...
roc_auc1 = metrics.auc(fpr, tpr) ##72.8
## test data
...
roc_auc2 = metrics.auc(fpr,tpr)##72.8
